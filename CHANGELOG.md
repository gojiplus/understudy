...
- Adopted the py-canon fleet standard: shared reusable CI/docs/release
  workflows, canon ruff/pyright/pydoclint configuration, and a
  py-canon-managed Sphinx config.
