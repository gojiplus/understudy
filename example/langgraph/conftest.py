"""pytest fixtures for LangGraph understudy example tests.

This file provides fixtures for testing LangGraph agents using understudy.
"""
...
@pytest.fixture
def app(mocks):
    """Create a LangGraphApp wrapping the customer service agent.
